...
?>
				...
				<a href='https://xmpp.net/result.php?domain=<?= urlencode($result_domain) ?>&amp;type=<?= $result_type ?>'><img src='https://xmpp.net/badge.php?domain=<?= urlencode($result_domain) ?>' width='161' height='18' alt='xmpp.net score' /></a>
