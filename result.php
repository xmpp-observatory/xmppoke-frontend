...
?>
		<dl class="dl-horizontal">
			...
			<dt>Public key</dt>
			<dd><?= $cert["pubkey_bitsize"] ?> <?= $cert["pubkey_type"] ?> <?= ($cert["pubkey_bitsize"] < 2048 && ($cert["pubkey_type"] === "RSA" || $cert["pubkey_type"] === "DSA")) ? " <span class='label label-warning'>WEAK</span>" : "" ?></dd>
			<dt>Valid from</dt>
